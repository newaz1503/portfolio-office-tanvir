...
const tableColumns = [
  { field: "image", title: "Image", image:true, height:'50px',width:'50px' },
  { field: "title", title: "Title" },
  { field: "category", title: "Category", subfield:'name'},
  { field: "portfolio_types", title: "Portfolio Type" , subfield:'name'},
